...
from flex_shared_resources.utils.conversions import pose_to_lists, point_to_pose_stamped, list_to_orientation, list_to_position
    ...
    def transform_pose(self, angle_offset=0):
        ...
        for key in pose_transform:
            ...
            if added_pose is None:
                rospy.logwarn(
                    '[PICK PLACE] Failed to add pose stamed: they are defined with respect to different frames!')
